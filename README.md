...
You can modify the `system_message` variable in the notebook to change the chatbot's role, style, personality, or scope. For example, you could adjust it for different age groups or subjects.
